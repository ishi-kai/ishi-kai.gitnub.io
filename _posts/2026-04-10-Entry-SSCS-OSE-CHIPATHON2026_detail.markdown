...
![Chipathon Theme: “Build It. Test It. Publish It.”](https://sscs.ieee.org/wp-content/uploads/ChatGPT-Image-Mar-28-2026-10_53_40-PM.png)
...
「測定を通じて学ぶ」設計（[MOSbius](https://mosbius.org/0_front_matter/intro.html)スタイルのチップ）は、幅広い利用可能性と実践的な学習に重点を置いています。自動化の導入も可能です。
- [MOSbius](https://mosbius.org/0_front_matter/intro.html)
...
## 活動場所
日本チームに関しては、ISHI会Discord内の「[sscs-pico-chipathon関連](https://discord.gg/7Pc3wve2uV)」チャンネルで活動予定です。  
...
## 公式リンク
- 公式サイト
    - [Chipathon 2026 github](https://github.com/sscs-ose/sscs-chipathon-2026)
- 定例Mtg
    - 未定
