---
layout: post
title:  "ISHI会版OpenMPW OpenSUSI-TR10-1　OPAMPハンズオンセミナー"
date:   2026-04-14 00:00:00 +0900
categories: openmpw shuttle OpenSUSI-TR10
---

# [2026年08月イベント：二日でOPAMP回路ハンズオン](https://connpass.com/event/390290/)募集の概要
...
* 【チップ製造（あり）枠参加資格】（なし枠での条件は「3」のみとなります）
    ...
    * レイアウトは自宅で一週間以内に完成されられる方(サンプルをコピペしただけの回路やレイアウトの場合、受付を拒否します。)
    * **チップ製造あり枠のみ、[2026年08月イベント：二日でOPAMP回路ハンズオン](https://connpass.com/event/390290/) と [2026年08月イベント：オーディオ用OPAMP半導体ハンズオン](https://connpass.com/event/390873/)のどちらか一方のみ申し込めます。両方に登録されていた場合、落選とします。**



[OPAMP設計コンテスト](https://www.opamp-contest.org/)に出場する方向けのOPAMP設計の基礎を学ぶコースの試験運用版の形で実施されます。そのため、かなりガチ目のハンズオンとなりますので、本気でアナログ回路を勉強したい方のみご参加ください。  
...
### 募集サイト
* [2026年08月イベント：二日でOPAMP回路ハンズオン](https://connpass.com/event/390290/) 
