---
layout: post
title:  "ISHI会版OpenMPW OpenSUSI-TR10-1開始！！！～2026年OpenSUSI-TR10（OpenSUSI-TR10シャトル）の相乗り募集：東京編～"
date:   2026-05-06 00:00:00 +0900
categories: openmpw shuttle OpenSUSI-TR10
---

# 半導体設計初めての人向けのセミナーのご案内
## [2026年07月イベント：初めての半導体設計・製造体験！一日で作るインバータ回路ハンズオン：東京編](https://ishikai.connpass.com/event/390287/)の参加者募集の概要
半導体の基本用語の「EDA」や「PDK」さえ、何？そもそも「シャトル」って何？という方向けにハンズオンセミナーします。  
...
ただし、本ハンズオンは本当に設計ツールの使い方を学ぶだけのハンズオンとなりますので、半導体の基礎知識も併せて学習したい方はスポンサーのZEPエンジニアリング（株）様が提供する講座を受講してください。  

- ZEPエンジニアリング（株）様が提供する講座
    - [一緒に作る！高校知識で始める「世界に1つだけのIC」～Myシリコン・チップを手に入れる～](https://www.zep.co.jp/)
        - 開催日：7月2日（土）
        - 会場：オンライン
...
- 募集サイト
    - [2026年07月イベント：初めての半導体設計・製造体験！一日で作るインバータ回路ハンズオン：東京編](https://ishikai.connpass.com/event/390287/)
