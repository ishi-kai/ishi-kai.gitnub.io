...
C {MP.sym} 2760 -690 0 0 {name=MDRVP model=PMOS w=48u l=4u m=48 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
C {MN.sym} 2760 -510 0 0 {name=MDRVN model=NMOS w=24u l=4u m=48 as=0 ad=0 ps=0 pd=0 nrd=0 nrs=0 spiceprefix=X}
